...
public class LoginPane extends BorderPane {
    ...
    private void changePasswordView() {
        ...
        newPasswordButton.setBackground(new Background(new BackgroundFill(Color.web("#87CEEB",1.0), null, null)));
        newPasswordButton.setMinWidth(100);
        HBox buttonBox = new HBox();
        buttonBox.getChildren().addAll(new CancelButton(), newPasswordButton);
        buttonBox.setAlignment(Pos.CENTER);
